...
import { TeamManageHeader, TeamManageTabs, TeamMembers } from '@/components/teams/manage'
...
const handleTeamSelected = (data: { teamId: string; teamName: string }) => {
  // If we're switching to a different team, navigate to that team's members page
  if (data.teamId !== teamId) {
    router.push(`/teams/manage/${data.teamId}/members`)
  }
}
