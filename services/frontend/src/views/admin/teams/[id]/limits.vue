...
import { TeamDetailTabs, TeamDetailPageHeading, LimitsTab } from '@/components/admin/teams'
...
// Handle team updates from child component (LimitsTab)
  ...
  <NavbarLayout>
    ...
    <div class="space-y-6 mt-6">
      ...
      <TeamDetailTabs v-else-if="team" :team="team" :team-id="teamId">
        <LimitsTab :team="team" @updated="handleTeamUpdated" />
      </TeamDetailTabs>
    </div>
  </NavbarLayout>
</template>
