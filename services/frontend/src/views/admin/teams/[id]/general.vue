...
import { TeamDetailTabs, TeamDetailPageHeading, GeneralTab } from '@/components/admin/teams'
...
// Handle team updates from child component (GeneralTab)
  ...
  <NavbarLayout>
    ...
    <div class="space-y-6 mt-6">
      ...
      <TeamDetailTabs v-else-if="team" :team="team" :team-id="teamId">
        <GeneralTab :team="team" @updated="handleTeamUpdated" />
      </TeamDetailTabs>
    </div>
  </NavbarLayout>
</template>
