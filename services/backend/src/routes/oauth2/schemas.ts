...
// NOTE: Device information schemas removed as part of strategic pivot to Satellite Service
// No longer needed since users simply add URLs to VS Code instead of installing CLI software
