...
export const createServer = async () => {
  ...
  // Skip this check if database initialization was intentionally skipped (e.g., API spec generation)
  if (process.env.SKIP_DATABASE_INIT === 'true') {
    server.log.info('Skipping database startup check (SKIP_DATABASE_INIT=true)');
  } else {
