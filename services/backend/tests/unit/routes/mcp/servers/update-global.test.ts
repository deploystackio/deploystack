  ...
  describe('PUT /mcp/servers/global/:id', () => {
    ...
    it('should handle complex update payloads', async () => {
      ...
      const updatedServer = {
        ...
        github_account_id: null,
        github_stars: null,
        website_url: 'https://complex-server.example.com',
        language: 'typescript',
        runtime: 'node',
        packages: JSON.stringify([{ type: 'npm', command: 'npm install' }]),
        remotes: null,
      ...
      const complexUpdateRequest = {
        ...
        body: {
          ...
          description: 'A comprehensive server update',
          long_description: 'This is a detailed description',
          repository_url: 'https://github.com/complex/server',
          repository_source: 'github',
          repository_id: 'complex/server',
          repository_subfolder: null,
          git_branch: 'main',
          website_url: 'https://complex-server.example.com',
          language: 'typescript',
          runtime: 'node',
          packages: [{ type: 'npm', command: 'npm install' }],
          remotes: null,
      ...
      const testCases = [
        {
          ...
          setup: () => {
            ...
            const updatedServer = { 
              ...
              long_description: null, github_url: null, git_branch: null, website_url: null, language: 'javascript', runtime: 'node',
              runtime_min_version: null, packages: '[]', remotes: null, tools: '[]', resources: null, prompts: null, visibility: 'global',
