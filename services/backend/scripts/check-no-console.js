 ...
 */
function main() {
  console.log('🔍 Checking for console.* statements in backend source code...\n');
  ...
  if (violations.length === 0) {
    console.log('✅ No console statements found in backend source code.');
    console.log('✅ All checks passed!\n');
    process.exit(0);
  } else {
    console.log('❌ Console statements found in backend source code:\n');
